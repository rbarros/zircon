 ...
 *
 */
class FileLoader implements \Illuminate\Config\LoaderInterface {
     ...
     * @return void
     */
    public function __construct(Filesystem $files, $defaultPath, $ext='yml')
    {
        $this->files = $files;
    ...
    public function load($environment, $group, $namespace = null)
    {
        ...
        $file = "{$path}/{$environment}/{$group}.".$this->ext;
    ...
    public function cascadePackage($env, $package, $group, $items)
    {
        ...
        $file = "packages/{$package}/{$group}.".$this->ext;
    ...
    {
        $file = "packages/{$package}/{$env}/{$group}.".$this->ext;
